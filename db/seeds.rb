...
Article.create(:allow_comments => true, :allow_pings => true, :author => "Mr Typo", :body => "This is your second article. Get with the program!", :guid => "9e17f67a-ab97-42e1-91df-1084c2d3ba7b", :id => 2, :permalink => "get-program", :post_type => "read", :published => true, :published_at => "2012-06-09 21:51:56 UTC", :settings => {"password"=>""}, :state => "published", :text_filter_id => 5, :title => "Second Article!", :type => "Article", :user_id => 1)
